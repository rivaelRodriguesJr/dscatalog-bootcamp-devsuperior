...
public class ProductResourceTests {
	...
	@Test
	public void updateShouldReturnProudctDTOWhenIdExists() throws Exception {
	...
	public void findAllShouldReturnPage() throws Exception {
		...
		RequestBuilder request = get("/products").accept(MediaType.APPLICATION_JSON);
		ResultActions result = mockMvc.perform(request);
	...
	public void findByIdShouldReturnProductWhenIdExists() throws Exception {
		...
		RequestBuilder request = get("/products/{id}", existingId).accept(MediaType.APPLICATION_JSON);
		ResultActions result = mockMvc.perform(request);
	...
	public void findByIdShouldThrowResourceNotFoundExceptionWhenIdDoesNotExists() throws Exception {
		...
		RequestBuilder request = get("/products/{id}", nonExistingId).accept(MediaType.APPLICATION_JSON);
		ResultActions result = mockMvc.perform(request);
